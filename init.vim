...
set smartcase " If the search contains capitals, override ignorecase
set incsearch " Matches as you type
set number " Line numbers
set relativenumber " Relative line numbers
set splitbelow " Open new vertical windows below
set splitright " Open new horizontal windows to the right
set tabstop=4  " Size of the tab in spaces
set shiftwidth=4
set expandtab " Convert all tabs to spaces
set nofen " Disable code folding
let g:python_host_prog = '/usr/bin/python' " Make healthcheck warnings shut up
let g:python3_host_prog = '/usr/bin/python3.6' " Make healthcheck warnings shut up
"
...
nnoremap <silent> <SPACE>p :CtrlP<RETURN>
